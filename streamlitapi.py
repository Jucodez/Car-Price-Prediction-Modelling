...
def main():
    ...
    'Hyundai': [
        'i20', 'i10', 'Elantra', 'Getz', 'Venue', 'EON', 'Accent',
        'Verna', 'Grand i10', 'Xcent', 'Creta', 'Sonata', 'Santro', 'Elite'
    ],
    'Kia': ['Seltos'],
    'Mahindra': ['Logan', 'KUV 100', 'XUV300', 'Verito'],
    'Mahindra Renault': ['Logan'],
    'Maruti': [
        'A-Star', 'Omni', 'Eeco', '800', 'Ciaz', 'S-Presso', 'Baleno',
        'Alto', 'Esteem', 'S-Cross', 'Wagon R', 'Ignis', 'Zen',
        'Vitara Brezza', 'Swift', 'SX4', 'Celerio', 'Ritz', 'Dzire'
    ],
    ...
    # Input fields for other variables with validation
    ...
    if st.button('Predict'):
        ...
        if None not in [Year, Km_driven, engine, max_power, mileage_kmpl]:
            try:
                # Convert inputs to appropriate types and make the prediction
                prediction = model.predict([[Year, Km_driven, Fuel, Seller, Transmission, Owner, engine, max_power, brand, selected_model, mileage_kmpl]])
